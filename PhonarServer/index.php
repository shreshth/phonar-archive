                        ...
                        <table>
                            <tr>
                                <td class="title-action">
                                    <a href="/download">
                                        <img class="title-action-image" src="img/download.png"/>
                                        <span class="title-action-text">Download App</span>
                                    </a>
                                </td>
                                <td class="title-action">
                                    <a href="/preorder">
                                        <img class="title-action-image" src="img/order.png"/>
                                        <span class="title-action-text">Pre-order Devices</span>
                                    </a>
                                </td>
                            </tr>
                        </table>
